...
export default function LoginPage() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-[calc(24px+var(--safe-top))]">
      <div className="flex flex-col items-center gap-1 mb-10">
        <span className="font-display text-2xl font-medium text-text">
          Business Ops
        </span>
        <span className="text-sm text-text-muted">
          Clients, leads, and payments.
        </span>
      </div>
  ...
  return (
    <>
      <button
        onClick={signIn}
        disabled={loading}
        className="flex w-full max-w-xs items-center justify-center gap-3 rounded-full border border-border-strong bg-surface px-6 py-3.5 text-[15px] font-medium text-text transition-colors active:bg-surface-raised disabled:opacity-60"
      >
        <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
          ...
          <path
            fill="#FBBC05"
            d="M3.95 10.7A5.4 5.4 0 0 1 3.66 9c0-.59.1-1.17.29-1.7V4.96H.95A9 9 0 0 0 0 9c0 1.45.35 2.83.95 4.04l3-2.33Z"
          />
          <path
            fill="#EA4335"
